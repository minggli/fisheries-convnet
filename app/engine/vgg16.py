...
conv_layer_1 = cnn.add_conv_layer(x, [[3, 3, 3, 64], [64]])
conv_layer_2 = cnn.add_conv_layer(conv_layer_1, [[3, 3, 64, 64], [64]])
max_pool_1 = cnn.add_pooling_layer(conv_layer_2)
conv_layer_3 = cnn.add_conv_layer(max_pool_1, [[3, 3, 64, 128], [128]])
conv_layer_4 = cnn.add_conv_layer(conv_layer_3, [[3, 3, 128, 128], [128]])
max_pool_2 = cnn.add_pooling_layer(conv_layer_4)
conv_layer_5 = cnn.add_conv_layer(max_pool_2, [[3, 3, 128, 256], [256]])
conv_layer_6 = cnn.add_conv_layer(conv_layer_5, [[3, 3, 256, 256], [256]])
conv_layer_7 = cnn.add_conv_layer(conv_layer_6, [[3, 3, 256, 256], [256]])
max_pool_3 = cnn.add_pooling_layer(conv_layer_7)
conv_layer_8 = cnn.add_conv_layer(max_pool_3, [[3, 3, 256, 512], [512]])
conv_layer_9 = cnn.add_conv_layer(conv_layer_8, [[3, 3, 512, 512], [512]])
conv_layer_10 = cnn.add_conv_layer(conv_layer_9, [[3, 3, 512, 512], [512]])
max_pool_4 = cnn.add_pooling_layer(conv_layer_10)
conv_layer_11 = cnn.add_conv_layer(max_pool_4, [[3, 3, 512, 512], [512]])
conv_layer_12 = cnn.add_conv_layer(conv_layer_11, [[3, 3, 512, 512], [512]])
conv_layer_13 = cnn.add_conv_layer(conv_layer_12, [[3, 3, 512, 512], [512]])
max_pool_5 = cnn.add_pooling_layer(conv_layer_13)
fc1 = cnn.add_dense_layer(max_pool_5, [[3 * 5 * 512, 4096], [4096],
                                       [-1, 3 * 5 * 512]])
drop_out_layer_1 = cnn.add_drop_out_layer(fc1, keep_prob)
fc2 = cnn.add_dense_layer(drop_out_layer_1, [[4096, 1000], [1000], [-1, 4096]])
